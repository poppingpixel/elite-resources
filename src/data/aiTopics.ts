...
export const Q1_TOPICS: AITopic[] = [
    ...
    { id: 7, name: 'Transformer Architecture', category: 'Core Neural Networks', quarter: 'Q1', difficulty: 8, status: 'not_started', keyPapers: ['Attention Is All You Need 2017'], estimatedHours: 30, hasImplementation: false, hasBlogPost: false },
...
export const Q2_TOPICS: AITopic[] = [
    ...
    { id: 119, name: 'Offloading & Memory Management', category: 'Scaling & Efficiency', quarter: 'Q2', difficulty: 6, status: 'not_started', keyPapers: ['CPU/NVMe Offloading'], estimatedHours: 15, hasImplementation: false, hasBlogPost: false },
